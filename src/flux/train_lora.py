...
def main(args):
    ...
    if args.pretrained_lora_path and os.path.exists(args.pretrained_lora_path):
        ...
        # Convert standard LoRA format → PEFT-compatible format
        ...
        logger.warning("‼️ --pretrained_inpaint_model_name_or_path not specified or path does not exist, skipping load.")
